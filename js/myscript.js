					...
					switch(display_by)
					{
						case "cate":
							...
							{							
								if (sort == "" && display == "")
								{
									short_code ='[featured_product]';

								}
								else if ( display != "" && sort == "")
								{
									short_code ='[featured_product display="' +display+'"]';
								}
								else if ( sort != "" && display == "")
								{
									short_code ='[featured_product sortingby="'+sort+'"]';
								}
								else
								{
									short_code ='[featured_product sortingby="'+sort+'" display="' +display+'"]';
								}								
							}
							else
							{
								if (sort == "" && display == "")
								{
									short_code ='[featured_product cate="'+cate+'"]';
								}
								else if ( display != "" && sort == "")
								{
									short_code ='[featured_product cate="'+cate+'" display="' +display+'"]';
								}
								else if ( sort != "" && display == "")
								{
									short_code ='[featured_product cate="'+cate+'" sortingby="'+sort+'"]';
								}
								else
								{
						...
						case "id":
							...
							if (list.length > 0)
							{
								if (sort == "" && display == "")
								{
									short_code ='[featured_product id="'+list+'"]';
								}
								else if ( display != "" && sort == "")
								{
									short_code ='[featured_product id="'+list+'" display="' +display+'"]';
								}
								else if ( sort != "" && display == "")
								{
									short_code ='[featured_product id="'+list+'" sortingby="'+sort+'"]';
								}
								else
								{
									short_code ='[featured_product id="'+list+'" sortingby="'+sort+'" display="' +display+'"]';
								}
							}
							else
							{
